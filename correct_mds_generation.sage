...
PRIME_NUMBER = 0
if FIELD == 1 and len(sys.argv) != 6:
    print("Please specify a prime number (in hex format)!")
    exit()
elif FIELD == 1 and len(sys.argv) == 6:
    PRIME_NUMBER = int(sys.argv[5], 16) # e.g. 0xa7, 0xFFFFFFFFFFFFFEFF, 0xa1a42c3efd6dbfe08daa6041b36322ef
